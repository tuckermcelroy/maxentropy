...
We examine the "Food Services and Drinking Places" data from the Retail Trade and 
Food Services database of the [U.S. Census Bureau](https://www.census.gov/retail/index.html),
referred to as *Food* for short. The data covers a span from January 1992 through 
March 2023. We apply R functions that implement the methodology described
...
The data was downloaded on June 5, 2023. We load it from the repo, focusing on
the time period after 2008. 
 
```{r}
food <- read.table(url("https://raw.githubusercontent.com/tuckermcelroy/maxentropy/refs/heads/main/Food.dat"))
period <- 12
food <- ts(food[-seq(1,192),1],start=c(2008,1),frequency=period)
plot(food)
```

Graph the logged data, and set up variables for analysis.
